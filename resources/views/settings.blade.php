...
@section('content')
    <div class="mainDashboard">
        <form class="settings-form" method="POST" action="{{route('settings')}}" enctype="multipart/form-data">
            @csrf
            <div class="container">
                            ...
                            <div class="rightCol col-sm-12 col-md-8 col-lg-8">
                                <div class="container mt-5 mySettings">
                                    ...
                                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                                    ...
                                                    <div class="col-md-12 textarea">
                                                        <div class="py-3">
                                                            <div class="row">
                                                                <div class="col-md-12 py-2">
                                                                    <label>Show Me</label>
                                                                    <select class="form-select textarea muiSelect" name="search_preferences[]" id="choices-multiple-remove-button" placeholder="Select Property Type" multiple required>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 py-2">
                                                        ...
                                                        <div class="shadow-sm border slimPic" style="position: relative;" >
                                                            ...
                                                            <img src="{{$user->avatar_url}}" class="avatar-image {{in_array($user->avatar,['1.png','2.png','3.png','4.png','5.png','6.png','7.png','8.png','9.png','10.png','11.png','12.png','13.png','14.png','15.png','16.png','17.png','18.png','19.png','20.png','21.png','22.png','23.png','24.png','25.png','26.png','27.png','28.png','29.png','30.png'])?"d-none":""}}" style="position: absolute; top:0;left:0;width:100%; height:100%; object-fit: cover; z-index: 90;" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12 py-2 w-100 ">
                                                        <div class="shadow-sm border slimPic mb-4" style="height: 12rem; position: relative;">
                                                            ...
                                                            <img src="{{$user->cover_url}}" class="user-cover-image {{in_array($user->cover_photo,['1.jpg','2.jpg','3.jpg','4.jpg','5.jpg','6.jpg','7.jpg','8.jpg','9.jpg','10.jpg','11.jpg','12.jpg','13.jpg','14.jpg'])?"d-none":""}}" style="position: absolute; top:0;left:0;width:100%; height:100%; object-fit: cover; z-index: 90;" />
                                                        </div>
                                                        <p class="small mb-3">
                                        ...
                                        <button class="btn btn-lg mt-4 w-25 mb-4 change">Save Changes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
