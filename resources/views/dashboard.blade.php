                ...
                <div class="p-3 p-md-4 mt-2 mb-5 card">
                  <div class="d-md-flex justift-content-between userDetails">
                    <div class="d-md-flex border-end pr-3 w-100 me-3 mb-3">
                      <div class="me-3">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                      </div>
                      <a href="/" class="text-black text-decoration-none">
                        <span>
                          <div class="text-600">My Username</div>
                          <div class="small opacity-80 text-sm-start" style="max-width: 150px">{{$user->user_name}}</div>
                        </span>
                      </a>
                    </div>
                    ...
                    <div class="d-md-flex w-100">
                      ...
                      <a href="/" class="text-black text-decoration-none">
                        <span>
                          ...
                          <div class="text-sm-start opacity-80 text-truncate" style="max-width: 150px">{{$user->email}}</div>
                        </span>
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="lh-30">
                        ...
                        We are constantly updating and improving our service. If you have any questions or feedback get in touch - we would love to hear them.
                      </div>
                      <div class="mt-3 fs-lg"><a href="/" class="badge text-bg-light p-2" style="border: 1px solid #e0e0e0;background-color: #fff!important;">Contact us</a></div>
                    </div>
                    <div class="col-md-6">
                      <div class="my-4 my-md-0">
                        <div class="position-relative">
                          <img src="{{asset('assets/pictures/dashboard.jpg')}}" class="img-fluid rounded-2" alt="img" />
                        </div>
                      </div>
                    </div>
                  </div>
