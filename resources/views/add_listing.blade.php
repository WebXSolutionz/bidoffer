                    ...
                    <div class="tab-content basic">
                            ...
                            <form action="{{ route('save-pl-step1') }}" method="POST">
                                ...
                                <div class="rightBody container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="city_id" class="form-control multiselect" placeholder="Select City" required >
                                            @foreach ($cities as $city)
                                                <option value="{{$city->id}}" {{ (@$auction->city_id==$city->id)?"selected":"" }} >{{$city->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <select name="state_id" class="form-control" required >
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{$state->id}}" {{ (@$auction->state_id==$state->id)?"selected":"" }}>{{ucwords($state->name)}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="tab-pane container p-0  {{$step==2?"active":""}} pb-2" id="menu1">
                            ...
                            <div class="rightBody container">
                                ...
                                <div class="my-2">
                                    <input type="text" name="keywords" class="form-control mb-0" value="{{@$auction->keywords}}" required>
                                    @if($errors->has('keywords'))
                                        <div class="small error">{{ $errors->first('keywords') }}</div>
                                    @endif
                                    <span class="small opacity-50">Add key words of the best property features, So People
                                        can search for
                                        them. Separate each keyword with a comma. Sample keywords: Pool, Waterfront, Garage,
                                        Dock,
                                        etc</span>
                                </div>
                                <div class="form-group mt-4">
                                    ...
                                    {{-- <select class="form-control" name="bedroom_id" > --}}
                                        ...
                                        <label class="m-2">{{$bedroom->name}} <input type="radio" name="bedroom_id" value="{{$bedroom->id}}" {{(@$auction->bedroom_id == $bedroom->id)?"checked":""}} ></label>
                                        @endforeach
                                    {{-- </select> --}}
                                </div>
                                <div class="form-group mt-4">
                                    ...
                                    <div>
                                        @foreach ($bathrooms as $bathroom)
                                            <label class="m-2">{{$bathroom->name}} <input type="radio" name="bathroom_id" value="{{$bathroom->id}}" {{(@$auction->bathroom_id == $bathroom->id)?"checked":""}} ></label>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                            <div class="rightFooter">
                                <a href="{{ route('add-listing').'?step=1&id='.$id }}" class="btn btn-lg text-600 btnPrevious position-absolute" type="button"><i
                        ...
                        <div class="tab-pane container {{ $step==3?"active":"" }}" id="menu2">
                            ...
                            <div class="rightBody container row">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <div>
                                        <select class="multiselect" name="financing_ids[]" placeholder="Select Financing Accepted" multiple>
                                            @foreach ($financings as $financing)
                                            <option value="{{$financing->id}}" {{(@$auction->financing)?in_array($financing->id,@$auction->financing->pluck('financing_id')->toArray())=="Yes"?"selected":"":null}}>{{$financing->name}}</option>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-select mb-0" name="autcion_type" id="autcion_type" onchange="changeAuctionType(this.value);" >
                                        <option value="Normal" {{@$auction->autcion_type=="Normal"?"selected":""}}>Normal (Timer)</option>
                                        <option value="Traditional" {{@$auction->autcion_type=="Traditional"?"selected":""}}>Traditional (No Timer)</option>
                                    </select>
                                ...
                                <script>
                                    ...
                                    document.getElementById('autcion_type').change();
                                </script>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                        Auction Length
                                    ...
                                    <select class="form-select mb-0 auction_length" name="auction_length" required>
                                        <option value="1" class="normal-length" {{@$auction->auction_length=="1"?"selected":""}}>1 Day</option>
                                        <option value="3" class="normal-length" {{@$auction->auction_length=="3"?"selected":""}}>3 Days</option>
                                        <option value="5" class="normal-length" {{@$auction->auction_length=="5"?"selected":""}}>5 Days</option>
                                        <option value="7" class="normal-length" {{@$auction->auction_length=="7"?"selected":""}}>7 Days</option>
                                        <option value="10" class="normal-length" {{@$auction->auction_length=="10"?"selected":""}}>10 Days</option>
                                        <option value="14" class="normal-length" {{@$auction->auction_length=="14"?"selected":""}}>14 Days</option>
                                        <option value="21" class="normal-length" {{@$auction->auction_length=="21"?"selected":""}}>21 Days</option>
                                        <option value="30" class="normal-length" {{@$auction->auction_length=="30"?"selected":""}}>30 Days</option>
                                        <option value="45" class="normal-length" {{@$auction->auction_length=="45"?"selected":""}}>45 Days</option>
                                        <option value="60" class="normal-length" {{@$auction->auction_length=="60"?"selected":""}}>60 Days</option>
                                        <option value="-1" class="traditional-length d-none" {{@$auction->auction_length=="-1"?"selected":""}}>No time limit</option>
                                    </select>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        ...
                                        <input type="number" class="form-control border-start-0 mb-0" name="starting_price" min="0" required placeholder="0.00" value="{{@$auction->starting_price}}">
                                    </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        <i class="fa fa-dollar" id="basic-addon1"></i>
                                        <input type="number" name="buy_now_price" class="form-control border-start-0 mb-0" min="0" placeholder="0.00" value="{{@$auction->buy_now_price}}">
                                    </div>
                                    <span class="opacity-50 small">Here you can set a price for the user to buy this item
                                        outright.</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <div class="d-flex align-items-baseline">
                                        <i class="fa fa-dollar" id="basic-addon1"></i>
                                        <input type="number" class="form-control border-start-0 mb-0" name="reserve_price" min="0" placeholder="0.00" value="{{@$auction->reserve_price}}">
                                    </div>
                                    <span class="opacity-50 small">Here you can set the lowest price your willing to sell
                                        this item
                                        for.</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="heated_sqft" class="form-control mb-0" value="{{@$auction->heated_sqft}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="year_built" class="form-control mb-0" value="{{@$auction->year_built}}">
                                    <span class="opacity-50 small">(Custom input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="form-control" name="county_id">
                                        ...
                                        <option value="{{$county->id}}" {{@$auction->county_id==$county->id?"selected":""}}>{{$county->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="multiselect" name="ac_type_id[]" placeholder="Select Air Conditioning Type"
                                        multiple>
                                        @foreach ($ac_types as $ac_type)
                                        <option value="{{$ac_type->id}}" {{(@$auction->ac_types)?in_array($ac_type->id,@$auction->ac_types->pluck('air_conditioning_type_id')->toArray())=="Yes"?"selected":"":null}}>{{$ac_type->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="multiselect" name="fuel_id[]" placeholder="Select Heating/Fuel"
                                        ...
                                        <option value="{{$hf->id}}" {{(@$auction->fuel)?in_array($hf->id,@$auction->fuel->pluck('heating_fuel_id')->toArray())=="Yes"?"selected":"":null}}>{{$hf->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-control mb-0" name="pool">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="multiselect" name="water_view_id[]" placeholder="Select Water View"
                                        multiple>
                                        @foreach ($water_views as $wv)
                                        <option value="{{$wv->id}}" {{(@$auction->water_view_types)?in_array($wv->id,@$auction->water_view_types->pluck('water_view_type_id')->toArray())=="Yes"?"selected":"":null}}>{{$wv->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="multiselect" name="water_extra_id[]" placeholder="Select Water Extras"
                                        multiple>
                                        @foreach ($water_extras as $we)
                                        <option value="{{$we->id}}" {{(@$auction->water_extra)?in_array($we->id,@$auction->water_extra->pluck('water_extra_id')->toArray())=="Yes"?"selected":"":null}}>{{$we->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="multiselect" name="appliance_id[]" placeholder="Select Appliances Included"
                                        multiple>
                                        @foreach ($appliances as $appliance)
                                        <option value="{{$appliance->id}}" {{(@$auction->appliance)?in_array($appliance->id,@$auction->appliance->pluck('appliance_id')->toArray())=="Yes"?"selected":"":null}}>{{$appliance->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-select mb-0" name="hoa_association">
                                        <option value="Yes" {{@$auction->hoa_association=="Yes"?"selected":""}}>Yes</option>
                                        <option value="No" {{@$auction->hoa_association=="No"?"selected":""}}>No</option>
                                    </select>
                                    <span class="opacity-50 small">(Yes or No)</span>
                                </div>
                                ...
                                <div class="form-group col-md-12 mt-4">
                                    ...
                                    <div>
                                        <input type="text" name="hoa_manager_contact" class="form-control" value="{{@$auction->hoa_manager_contact}}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-select mb-0" name="hoa_fee_requirement">
                                        <option value="Required" {{@$auction->hoa_fee_requirement=="Required"?"selected":""}}>Required</option>
                                        <option value="Optional" {{@$auction->hoa_fee_requirement=="Optional"?"selected":""}}>Optional</option>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="hoa_fee" value="{{@$auction->hoa_fee}}">
                                    <span class="opacity-50 small">(Custom input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="form-select mb-0" name="hoa_payment_schedule">
                                        <option value="N/A" {{@$auction->hoa_payment_schedule=="N/A"?"selected":""}}>N/A</option>
                                        <option value="Annual" {{@$auction->hoa_payment_schedule=="Annual"?"selected":""}}>Annual</option>
                                        <option value="Monthly" {{@$auction->hoa_payment_schedule=="Monthly"?"selected":""}}>Monthly</option>
                                        <option value="Quarterly" {{@$auction->hoa_payment_schedule=="Quarterly"?"selected":""}}>Quarterly</option>
                                        <option value="Semi-Annually" {{@$auction->hoa_payment_schedule=="Semi-Annually"?"selected":""}}>Semi- Annually</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="condo_fee" value="{{@$auction->condo_fee}}">
                                    <span class="opacity-50 small">(Custom input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="form-select mb-0" name="condo_fee_schedule">
                                        <option value="Annual" {{@$auction->condo_fee_schedule=="Annual"?"selected":""}}>Annual</option>
                                        <option value="Semi-Annually" {{@$auction->condo_fee_schedule=="Semi-Annually"?"selected":""}}>Semi- Annually</option>
                                        <option value="Monthly" {{@$auction->condo_fee_schedule=="Monthly"?"selected":""}}>Monthly</option>
                                        <option value="Quarterly" {{@$auction->condo_fee_schedule=="Quarterly"?"selected":""}}>Quarterly</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="multiselect" name="fee_includes[]" placeholder="Select Fee Include" multiple>
                                        @foreach ($fee_includes as $fi)
                                        <option value="{{$fi->id}}" {{(@$auction->fee_includes)?in_array($fi->id,@$auction->fee_includes->pluck('fee_include_id')->toArray())?"selected":"":null}}>{{$fi->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-select mb-0" name="rental_restrictions">
                                        <option value="Yes" {{@$auction->rental_restrictions=="Yes"?"selected":""}}>Yes</option>
                                        <option value="No" {{@$auction->rental_restrictions=="No"?"selected":""}}>No</option>
                                    </select>
                                    <span class="small opacity-50">(Yes or No)</span>
                                </div>
                                <div class="form-group col-md-12 mt-4">
                                    ...
                                    <textarea style="width:100%; height:100px !important;" name="rental_restrictions_desription" class="form-control mb-0">{{@$auction->rental_restrictions_desription}}</textarea>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select name="number_of_pets_allowed" class="form-select mb-0">
                                        <option value="1" {{@$auction->number_of_pets_allowed=="1"?"selected":""}}>1</option>
                                        <option value="2" {{@$auction->number_of_pets_allowed=="2"?"selected":""}}>2</option>
                                        <option value="3" {{@$auction->number_of_pets_allowed=="3"?"selected":""}}>3</option>
                                        <option value="4" {{@$auction->number_of_pets_allowed=="4"?"selected":""}}>4</option>
                                        <option value="5" {{@$auction->number_of_pets_allowed=="5"?"selected":""}}>5</option>
                                        <option value="6" {{@$auction->number_of_pets_allowed=="6"?"selected":""}}>6</option>
                                        <option value="7" {{@$auction->number_of_pets_allowed=="7"?"selected":""}}>7</option>
                                        <option value="8" {{@$auction->number_of_pets_allowed=="8"?"selected":""}}>8</option>
                                        <option value="9" {{@$auction->number_of_pets_allowed=="9"?"selected":""}}>9</option>
                                        <option value="10+" {{@$auction->number_of_pets_allowed=="10+"?"selected":""}}>10+</option>
                                    </select>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="max_pet_weight" value="{{@$auction->max_pet_weight}}">
                                    <span class="small opacity-50">(Custom input)</span>
                                </div>
                                <div class="form-group col-md-12 mt-4">
                                    <label>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="mls_id" class="form-control mb-0" value="{{@$auction->mls_id}}">
                                    <span class="small opacity-50">(Custom input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="form-select" name="is_in_flood_zone">
                                        <option value="Yes" {{@$auction->flood_zone_code=="Yes"?"selected":""}}>Yes</option>
                                        <option value="No" {{@$auction->flood_zone_code=="No"?"selected":""}}>No</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="flood_zone_code" value="{{@$auction->flood_zone_code}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="number_of_floors_in_unit" value="{{@$auction->number_of_floors_in_unit}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="total_number_of_floors" value="{{@$auction->total_number_of_floors}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <select class="form-select mb-0" name="elevator">
                                        <option value="Yes" {{@$auction->elevator=="Yes"?"selected":""}}>Yes</option>
                                        <option value="No" {{@$auction->elevator=="No"?"selected":""}}>No</option>
                                    </select>
                                    <span class="small opacity-50">(Yes or No)</span>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="number_of_buildings" class="form-control mb-0" value="{{@$auction->number_of_buildings}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="number_of_units" class="form-control mb-0" value="{{@$auction->number_of_units}}">
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="unit_sizes" class="form-control mb-0" value="{{@$auction->unit_sizes}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="sqft_for_each_unit" class="form-control mb-0" value="{{@$auction->sqft_for_each_unit}}">
                                    {{-- <span class="small opacity-50">(example 2- 1/1., 2- 2/2)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-12 mt-4">
                                    <label>
                                        Are units occupied or vacant (list how many are occupied and how many are vacant):
                                    </label>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="expected_rental_amount" class="form-control mb-0" value="{{@$auction->expected_rental_amount}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="anual_gross_income" class="form-control mb-0" value="{{@$auction->anual_gross_income}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="anual_expense" class="form-control mb-0" value="{{@$auction->anual_expense}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="anual_net_income" class="form-control mb-0" value="{{@$auction->anual_net_income}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="total_monthly_rent" class="form-control mb-0" value="{{@$auction->total_monthly_rent}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="lease_terms" class="form-control mb-0" value="{{@$auction->lease_terms}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="tenant_pays" class="form-control mb-0" value="{{@$auction->tenant_pays}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" name="landlord_pays" class="form-control mb-0" value="{{@$auction->landlord_pays}}">
                                    {{-- <span class="small opacity-50">(If not currently rented)</span> --}}
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="escrow_amount" value="{{@$auction->terms->escrow_amount}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="inspection_perion" value="{{@$auction->terms->inspection_perion}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="buyer_agent_commission" value="{{@$auction->terms->buyer_agent_commission}}">
                                    <span class="opacity-50 small">(Custom Input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="buyer_premium" value="{{@$auction->terms->buyer_premium}}">
                                    <span class="opacity-50 small">(Custom Input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="seller_premium" value="{{@$auction->terms->seller_premium}}">
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <select class="form-select" name="success_fee_to_be_paid_by">
                                        <option value="Seller" {{@$auction->terms->additional_remarks=="Seller"?"selected":""}}>Seller</option>
                                        <option value="Buyer" {{@$auction->terms->additional_remarks=="Buyer"?"selected":""}}>Buyer</option>
                                        <option value="Seller's agent" {{@$auction->terms->additional_remarks=="Seller's agent"?"selected":""}}>Seller’s agent</option>
                                    </select>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="additional_remarks" value="{{@$auction->terms->additional_remarks}}">
                                    <span class="opacity-50 small">(Custom Input)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="property_list_date" value="{{@$auction->terms->property_list_date}}">
                                    <span class="opacity-50 small">(Custom Input)</span>
                                </div>
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="seller_name" value="{{@$auction->seller_name}}">
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                        Brokerage:
                                    </label>
                                    <input type="text" class="form-control mb-0" name="brokerage" value="{{@$auction->brokerage}}">
                                ...
                                <div class="form-group col-md-6 mt-4">
                                    ...
                                    <input type="text" class="form-control mb-0" name="license_number" value="{{@$auction->license_number}}">
                                    <span class="opacity-50 small">(If you are agent)</span>
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                    ...
                                    <input type="text" class="form-control mb-0" name="phone_number" value="{{@$auction->phone_number}}">
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                        Email:
                                    </label>
                                    <input type="text" class="form-control mb-0" name="email" value="{{@$auction->email}}">
                                </div>
                                <div class="form-group col-md-6 mt-4">
                                    <label>
                                        MLS ID #
                                    </label>
                                    <input type="text" class="form-control mb-0" name="seller_agent_mls_id" value="{{@$auction->seller_agent_mls_id}}">
                            ...
                            <div class="form-group col-md-6 mt-4">
                                ...
                                <select class="form-select mb-0" name="looking_another_property">
                                    <option value="Yes" {{@$auction->looking_another_property=="Yes"?"selected":""}}>Yes</option>
                                    <option value="No" {{@$auction->looking_another_property=="No"?"selected":""}}>No</option>
                                </select>
                                <span class="opacity-50 small">(Yes or No)</span>
                            </div>
                            ...
                            {{-- <div class="form-group col-md-6 mt-4">
                                <label>
                                    Link to Bid Your Offer listing for Seller’s ad on the Buyer’s auction:
                                </label>
                                <textarea type="text" class="form-control mb-0" name="seller_agent_mls_id"></textarea>
                            </div> --}}

                            <div class="rightFooter">
                                <a href="{{ route('add-listing').'?step=2&id='.$id }}" class="btn btn-lg text-600 btnPrevious position-absolute" type="button"><i
                                        class="fa fa-arrow-left me-2"></i>Previous
                                </a>
                                <button class="btn btn-lg text-600 btnNext position-absolute " type="submit">Next <i
                                        class="fa fa-arrow-right ms-2"></i></button>
                        ...
                        <div class="tab-pane container {{$step==4?"active":""}}" id="menu3">
                            ...
                            <div class="rightBody container row">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <span class="position-absolute bg-white px-3 fs-5" style="right:22px;">
                                        <span id="tatal_images">0</span><span class="opacity-5 text-500">/</span> <span
                                            class="_total">10</span>
                                    </span>
                                </div>
                                <div class="form-group mt-4">
                                    <div class="locationCard col-sm-12 col-md-3 col-lg-3 rounded-2" style="position: relative;">
                                        ...
                                        <input type="file" name="photos[]" multiple id="photo_files" onchange="checkImages();" style="position: absolute; top:0; left:0; width:100%;height:100%; opacity: 0; cursor: pointer;">
                                    </div>
                                </div>
                                <script>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-5">
                                    ...
                                    <div class="header-divider"></div>
                                    <span class="position-absolute bg-white px-3 fs-5" style="right:22px;">
                                        <span id="tatal_videos">0</span><span class="opacity-5 text-500">/</span> <span
                                            class="_total">10</span>
                                    </span>
                                </div>
                                <div class="form-group mt-4">
                                    <div class="locationCard col-sm-12 col-md-3 col-lg-3 rounded-2" style="position: relative;">
                                        ...
                                        <input type="file" name="videos[]" multiple id="video_files" onchange="checkVideos();" style="position: absolute; top:0; left:0; width:100%;height:100%; opacity: 0; cursor: pointer;">
                                    </div>
                                </div>
                                <script>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-5">
                                    ...
                                    <div class="header-divider"></div>
                                    <span class="position-absolute bg-white px-3 fs-5" style="right:22px;">
                                        <span id="tatal_audios">0</span><span class="opacity-5 text-500">/</span> <span
                                            class="_total">10</span>
                                    </span>
                                </div>
                                <div class="form-group mt-4">
                                    <div class="locationCard col-sm-12 col-md-3 col-lg-3 rounded-2" style="position: relative;">
                                        ...
                                        <input type="file" name="audios[]" multiple id="audio_files" onchange="checkAudios();" style="position: absolute; top:0; left:0; width:100%;height:100%; opacity: 0; cursor: pointer;">
                                    </div>
                                </div>
                            </div>
                            <script>
                            ...
                            <div class="rightFooter">
                                <a href="{{ route('add-listing').'?step=3&id='.$id }}" class="btn btn-lg text-600 btnPrevious position-absolute" type="button"><i
                                        class="fa fa-arrow-left me-2"></i>Previous
                                </a>
                                <button class="btn btn-lg text-600 btnNext position-absolute " type="submit">Next <i
                                        class="fa fa-arrow-right ms-2"></i></button>
                        ...
                        <div class="tab-pane container {{$step==5?"active":""}}" id="end">
                            ...
                            <div class="rightFooter">
                                ...
                                <button style="background:#049399!important;color:#fff;"
                                    class="btn btn-lg text-600 btnNext position-absolute" type="submit">Finish</button>
                            </div>
                            </form>
                        </div>
                    </div>
